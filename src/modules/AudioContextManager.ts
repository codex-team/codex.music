...
class AudioContextManager {
   ...
   * @param {Float32Array} real - an array of cosine terms (traditionally the A terms)
   * @param {Float32Array} imag - an array of sine terms (traditionally the B terms)
   * @param {PeriodicWaveConstraints} constraints - an dictionary object that specifies whether normalization should be disabled
   * @return {PeriodicWave}
   */
